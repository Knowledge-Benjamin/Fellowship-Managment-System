            ...
            <div className="glass-card p-6 w-full max-w-lg">
                ...
                {region.regionalHead && (
                    <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4 mb-4">
                        <p className="text-purple-400 text-sm font-medium mb-1">Current Regional Head</p>
                        <p className="text-white">{region.regionalHead.fullName}</p>
                    </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-white text-sm font-medium mb-2">
                            Select New Regional Head <span className="text-red-400">*</span>
                        </label>
                        {fetchingMembers ? (
                    ...
                    <div className="bg-teal-500/10 border border-teal-500/30 rounded-lg p-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="text-sm">
                                <p className="text-teal-400 font-medium mb-1">Auto-Tag Applied</p>
                                <p className="text-gray-400">
                                    The selected member will receive the <code className="text-teal-300">REGIONAL_HEAD</code> tag automatically.
                                </p>
                            </div>
                        </div>
                    </div>
